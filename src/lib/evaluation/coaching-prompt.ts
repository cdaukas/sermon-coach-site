...
Order the affirmations strongest first. The first affirmation is the lead, and it should be the fullest, most developed paragraph in the entire report. Develop it to the depth and substance of the worked example above, so that on its own it carries more weight than any single paragraph in How To Grow. The remaining affirmations stay full developed paragraphs, but the lead is the heaviest block on the page. This is depth, not padding. Every sentence still carries a specific observation about this sermon.
