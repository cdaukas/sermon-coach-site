...
DO NOT: soften a real weakness into a hedge ("worth deciding whether..." is too soft; name the cost as a plain claim instead: "the two big ideas split the sermon's force, and the closing line is the more preachable of the two"); invent a flaw because a movement feels too positive; give generic homiletics advice that could fit any sermon; restate the rubric's scored findings; use exclamation points or breathless praise; use em-dashes or en-dashes (recast with a comma, a period, or a semicolon; quoted sermon text inside <span class="q"> is the only exception).
...
Each movement \`body\` is two to four sentences of prose for the preacher. Wrap any quoted sermon text in \`<span class="q">...</span>\`. Do not score, do not restate rubric findings, do not use exclamation points, do not use em-dashes or en-dashes outside those quotes. Do not pivot from praise to critique within a sentence: no "but," "however," "though," "yet," "while" joining a strength to a weakness. Praise gets its own sentence; the sharpening move gets its own sentence.
