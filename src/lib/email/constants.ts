...
export const BLOG_EMAIL_CTA_PARAGRAPH =
  "Run your next sermon through The Sermon Coach tool before Sunday. New here? Your first evaluation's free — no card, no commitment. Paste in a manuscript or transcript, get the full assessment back in a few minutes, and see if it's useful before you decide anything. Pass along to your pastor friends who preach!";
